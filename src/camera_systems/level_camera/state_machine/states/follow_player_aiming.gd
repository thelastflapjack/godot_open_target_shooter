...
# Looks over the player shoulder
...
func enter(_data: Dictionary={}) -> void:
	...
	GenUtils.connect_signal_assert_ok(_player, "aiming_stopped", self, "_on_player_aiming_stopped")


func exit() -> void:
	_camera_sys.camera.clear_exceptions()
	_player.disconnect("aiming_stopped", self, "_on_player_aiming_stopped")


############################
# Signal Connected Methods #
############################
func _on_player_aiming_stopped() -> void:
	emit_signal("change_state_request", "FollowPlayer")
